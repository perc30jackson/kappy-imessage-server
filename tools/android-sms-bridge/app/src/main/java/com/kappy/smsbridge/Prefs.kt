...
object Prefs {
    ...
    fun saveMacUrl(context: Context, url: String) {
        context.getSharedPreferences(RegRespForwarder.PREFS, Context.MODE_PRIVATE)
            .edit()
            .putString(RegRespForwarder.KEY_MAC_URL, url.trim())
            .apply()
    }
    ...
    fun macUrl(context: Context): String? =
        context.getSharedPreferences(RegRespForwarder.PREFS, Context.MODE_PRIVATE)
            .getString(RegRespForwarder.KEY_MAC_URL, null)
    ...
    fun appendLog(context: Context, line: String) {
        val prefs = context.getSharedPreferences(RegRespForwarder.PREFS, Context.MODE_PRIVATE)
